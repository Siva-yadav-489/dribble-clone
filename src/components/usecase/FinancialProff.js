  ...
  return (
    <div className="col-span-3 bg-[#f7f7f7]  p-8 w-full h-full max-lg:col-span-6 rounded-3xl">
      ...
      <div className="bg-white rounded-3xl p-6 mt-10 grid grid-cols-2 items-center">
        ...
        <div className="flex max-sm:flex-col col-span-2 py-5 mb-5">
          <div className="flex-1 mr-2 max-sm:m-1 border border-stone-200 rounded-2xl ">
            <div className="flex justify-between rounded-t-2xl items-center px-2 py-1 bg-[#f8f8f8]">
              ...
              <p className="text-sm font-matter-regular">Peoni Gibs</p>
              <p className="text-xs font-matter-light">
                <img
                  width="48"
                  height="48"
                  src="https://img.icons8.com/fluency/32/turkey-circular.png"
                  alt="turkey-circular"
            ...
            <div className="flex justify-between items-center pt-8 px-2 pb-3">
              <p className="text-3xl font-matter-semibold leading-[1.5rem]">
                $2500 <br />
                <span className="text-xs font-matter-regular text-stone-400 leading-tight">
                  Thu, 27 Feb 2025
                </span>
              </p>
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-6 border border-stone-200 rounded-full p-2 box-content"
              >
                <path
                  strokeLinecap="round"
            ...
            <div className="flex rounded-t-2xl justify-between items-center px-2 py-1 bg-[#f8f8f8]">
              ...
              <p className="text-xs font-matter-light">
                <img
                  width="48"
                  height="48"
                  src="https://img.icons8.com/fluency/32/usa-circular.png"
                  alt="turkey-circular"
                  className="inline bg-white p-2 rounded-full"
                />
                United States
        ...
        {/* row-3 */}
        <p className="text-lg text-stone-400 font-matter-regular">
          Your Saving <br />{" "}
          <span className="text-2xl font-matter-semibold text-black">
            $321,523.05
          </span>
        </p>
