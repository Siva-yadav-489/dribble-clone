...
const Hero = () => {
  return (
    <div className="flex flex-col items-center my-5">
      <h1 className="text-[5rem] leading-tight font-matter-regular text-center mt-8 tracking-tight">
        Turn Raw Data into <br></br> Actionable Insights - Instantly
      </h1>
      <p className="text-base text-stone-500 mt-10 font-matter-regular">
