...
const UserTrends = () => {
  return (
    <div
      className="grid grid-cols-2 -mt-9 gap-3 max-w-fit justify-start px-4 items-center bg-white/50 backdrop-opacity-10
 py-4  rounded-3xl "
    >
      ...
      <div className="col-span-2 flex justify-between">
        <div className="flex flex-col justify-end items-center">
          ...
          <p className="bg-[#f4781c28] rounded-lg h-[4.00rem] w-20 m-1">
            &nbsp;
          </p>
        ...
        <div className="flex flex-col justify-end items-center">
          ...
          <p className="bg-gradient-to-t from-[#f47419] to-[#fdac60] rounded-lg h-[9.65rem] w-20 m-1">
            &nbsp;
          </p>
        ...
        <div className="flex flex-col justify-end items-center">
          ...
          <p className="bg-[#f47a1c28] rounded-lg h-[8.04rem] w-20 m-1">
            &nbsp;
          </p>
          <p className="text-[0.6rem] text-stone-400 font-matter-light">
            35-44
        ...
        <div className="flex flex-col justify-end items-center">
          ...
          <p className="bg-[#f4781c28] rounded-lg h-[5.27rem] w-20 m-1">
            &nbsp;
          </p>
          <p className="text-[0.6rem] text-stone-400 font-matter-light">
            45-54
        ...
        <div className="flex flex-col justify-end items-center">
          ...
          <p className="bg-[#f4781c28] rounded-lg h-[4.25rem] w-20 m-1">
            &nbsp;
          </p>
          <p className="text-[0.6rem] text-stone-400 font-matter-light">
            55-64
        ...
        <div className="flex flex-col justify-end items-center">
          ...
          <p className="bg-[#f4781c28] rounded-lg h-[2.83rem] w-20 m-1">
            &nbsp;
          </p>
